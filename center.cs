...
/// delay pause
          ...
          Log(LogMsgType.Outgoing, "sending to modem" + data + "\n");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
        private void see_data_one_by_one(byte zz)
        {       
                string data="mmm";

                Log(LogMsgType.Outgoing, zz + "-------------------------------------------------------------" + "\n");
            if (CurrentDataMode == DataMode.Text)
            {
                // Send the user's text straight out the port
                //   buffer2[8] =   
                ...
                if (zz < 10)
                {
                    buffer1[0] = (byte)(zz + 0x30);
                    comport.Write(buffer4, 0, 8);
                    comport.Write(buffer1, 0, 1);
                    comport.Write("\r\n");
                ...
                else if (zz<100)
                {
                    ...
                    buffer1[0] = (byte)(z1 + 0x30);
                    buffer1[1] = (byte)(z2 + 0x30);
                    comport.Write(buffer4, 0, 8);
                    comport.Write(buffer1, 0, 2);
                    comport.Write("\r\n");
               ...
               // Read all the data waiting in the buffer
                 ...
                 String data2=cutting_data(data);
                // Display the text to the user in the terminal
                   // Log(LogMsgType.Incoming, data2);

                // Show in the terminal window the user's text
                Log(LogMsgType.Outgoing, "---respned :  " +data2 + "\n");
        ...
        private void see_mess_Click(object sender, EventArgs e)
        {
            ...
            byte zz = byte.Parse(no_message.Text);
            see_data_one_by_one(zz);
        }

        private void next_Click(object sender, EventArgs e)
        {
            ++xx;
            see_data_one_by_one(xx);
        }
      ...
      private void delete_Click(object sender, EventArgs e)
        {
            if (del_msg_nubmer.Checked == true)
            {
                del_message("0", msg_nubmer.Text);
            }
            else if (all_rec_read.Checked == true)
            {
                del_message("1", "0");
            }
            else if (rec_read_sent.Checked == true)
            {
                del_message("2", "0");

            }
            else if (rec_read_sent_stored.Checked == true)
            {
                del_message("3", "0");
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////deleting message
        public void del_message( string flg,string no)
        {
            //AT+CMGD=1,4
                ...
                // Show in the terminal window the user's text
                Log(LogMsgType.Outgoing, "sending to modem deleting no: " + no + "\n");

                string dat = comport.ReadExisting();
                // Display the text to the user in the terminal
                    Log(LogMsgType.Incoming,"reciving from modem : "+ dat);
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void del_msg_nubmer_CheckedChanged(object sender, EventArgs e)
        {
